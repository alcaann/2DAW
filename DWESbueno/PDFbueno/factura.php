...
class Factura extends FPDF
{
	...
	function lineas()
	{
		...
		$this->Cell(35,7,'CONCEPTO',1, 0 , 'L', true );
		...
		$this->Cell(35,7,'IMPORTE SIN IVA',1, 0 , 'L', true );
		$this->Ln();//Salto de línea para generar otra fila
		...
		{	
			...
			$this->Cell(35,7,$row['CONCEPTO'],1, 0 , 'L', $bandera );
			...
			$this->Cell(35,7,$row['IMPORTE_SIN_IVA'],1, 0 , 'R', $bandera );
			$this->Ln();//Salto de línea para generar otra fila
